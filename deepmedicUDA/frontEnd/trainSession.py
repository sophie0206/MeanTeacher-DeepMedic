...
from deepmedicUDA.frontEnd.session import Session
from deepmedicUDA.frontEnd.configParsing.utils import getAbsPathEvenIfRelativeIsGiven
from deepmedicUDA.frontEnd.configParsing.trainSessionParams import TrainSessionParameters
from deepmedicUDA.frontEnd.sessHelpers import makeFoldersNeededForTrainingSession, handle_exception_tf_restore

from deepmedicUDA.logging.utils import datetimeNowAsStr
from deepmedicUDA.neuralnet.cnn3d import Cnn3d
from deepmedicUDA.neuralnet.trainer import Trainer

from deepmedicUDA.routines.training import do_training
    ...
    def run_session(self, *args):
        ...
        with graphTf.as_default():
            ...
            with tf.variable_scope("trainer"):
                ...
                ##===========================================================================##
                trainerT = Trainer( *( self._params.get_args_for_trainer() + [cnn3dT] ) )
            ...
            cnn3dT.setup_ops_n_feeds_to_train( self._log,
                                              ...
                                              trainerT.get_param_updates_wrt_total_cost() # list of ops
                                            )
            ...
            cnn3dT.setup_ops_n_feeds_to_test( self._log,
                                             self._params.indices_fms_per_pathtype_per_layer_to_save ) # For validation with full segmentation
