...
from deepmedicUDA.frontEnd.configParsing.testSessionParams import TestSessionParameters
from deepmedicUDA.frontEnd.sessHelpers import makeFoldersNeededForTestingSession, handle_exception_tf_restore
    ...
    def _ask_user_if_test_with_random(self):
        ...
        try:
            user_input = raw_input("WARN:\t Testing was requested, but without specifying a pretrained, saved model to load.\n"+\
                                   ...
                                   "\t Please see documentation or run ./deepmedicUDARun -h for help on how to load a model.\n"+\
