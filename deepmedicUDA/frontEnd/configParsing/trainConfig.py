...
from deepmedicUDA.frontEnd.configParsing.utils import *
from deepmedicUDA.frontEnd.configParsing.config import Config
...
class TrainConfig(Config):
    ...
    TDCHANNELS_TR = "targetDomainChannelsTraining" # paths of target domain samples
    GT_LABELS_TR = "gtLabelsTraining"
    TDGT_LABELS_TR = "TDgtLabelsTraining"
    ROI_MASKS_TR = "roiMasksTraining"
    DDROI_MASKS_TR = "DDroiMasksTraining"
    ...
    ##====================================================##
    TDCHANNELS_VAL = "targetDomainChannelsValidation"
    ##====================================================##
    GT_LABELS_VAL = "gtLabelsValidation"
    TDGT_LABELS_VAL = "TDgtLabelsValidation"
    ...
    DDROI_MASKS_VAL = "DDroiMasksValidation"
    #~~~~~~~~~Full Inference~~~~~~~~
    ...
    SNUM = "NumofSdomainImagesForBadv"
