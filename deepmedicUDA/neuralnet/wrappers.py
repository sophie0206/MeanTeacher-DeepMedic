...
class CnnWrapperForSampling(object):
    ...
    def __init__(self, cnn3d) :
        ...
        self.DDfinalTargetLayer_outputShape = {"train": cnn3d.DDfinalTargetLayer.outputShape["train"],
                                             "val": cnn3d.DDfinalTargetLayer.outputShape["val"],
                                             "test": cnn3d.DDfinalTargetLayer.outputShape["test"]}
        # Pathways related
