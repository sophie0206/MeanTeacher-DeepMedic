...
import deepmedicUDA.neuralnet.optimizers as optimizers_dm
import deepmedicUDA.neuralnet.cost_functions as cfs
...
class Trainer(object):
    # I SHOULD NOT MAKE ANOTHER TRAINER-MANAGER. The deepmedicUDATrain() function is essentially the coordinator, intermigled with parser.
    ...
    def _setup_costs(self, log):
        ...
        log.print3("The value of alpha is : "+str(alpha))
	##========================================================================##
