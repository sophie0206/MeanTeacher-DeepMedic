...
from deepmedicEN.logging.accuracyMonitor import AccuracyOfEpochMonitorSegmentation
from deepmedicEN.neuralnet.wrappers import CnnWrapperForSampling
from deepmedicEN.dataManagement.sampling import getSampledDataAndLabelsForSubepoch, getTDSampledDataAndLabelsForSubepoch
from deepmedicEN.routines.testing import performInferenceOnWholeVolumes
...
def doTrainOrValidationOnBatchesAndReturnMeanAccuraciesOfSubepoch(log,
    ...
    for batch_i in range(number_of_batches):
        ...
        if train_or_val=="train" :
            ...
            LabelsForBadv = [1] * cnn3d.batchSize_seg["train"] + [0] * cnn3d.batchSize_seg["train"]
            ...
            listWithNumberOfRpRnPpPnForEachClass = listWithCostMeanErrorAndRpRnTpTnForEachClassFromTraining[1:21] # 21
            
            DDlistWithNumberOfRpRnPpPnForEachClass = listWithCostMeanErrorAndRpRnTpTnForEachClassFromTraining[21:] # 21
...
def do_training(sessionTf,
        ...
        DDlistOfFilepathsToGtLabelsOfEachPatientValidationOnSamplesAndDsc,
                ...
                #-------Sampling Type---------
                samplingTypeInstanceTraining, # Instance of the deepmedicEN/samplingType.SamplingType class for training and validation
...
##===============================================================================================================##
    ...
    tupleWithModulesToImportWhichAreUsedByTheJobFunctions = ( "from __future__ import absolute_import, print_function, division",
                "time", "numpy as np", "from deepmedicEN.dataManagement.sampling import *" )
...
#SDlabelsForCentralOfSegmentsForSubepVal,
