...
from deepmedic.dataManagement.sampling import getSampledDataAndLabelsForSubepoch, getTDSampledDataAndLabelsForSubepoch
...
def doTrainOrValidationOnBatchesAndReturnMeanAccuraciesOfSubepoch(log,
                                                                ...
                                                                SDchannsOfSegmentsForSubepPerPathway,
    ...
    for batch_i in range(number_of_batches):
        ...
        if train_or_val=="train" :
            ...
            ##====================================================================================##
            index_to_data_for_batch_min_seg = batch_i * cnn3d.batchSize_seg["train"]
            index_to_data_for_batch_max_seg = (batch_i + 1) * cnn3d.batchSize_seg["train"]


            index_to_data_for_batch_min_adv = batch_i * cnn3d.batchSize_adv["train"] // 2
            index_to_data_for_batch_max_adv = (batch_i+1) * cnn3d.batchSize_adv["train"] // 2
            ##====================================================================================##
            feeds = cnn3d.get_main_feeds('train')

            ##=================================20 segs from S, 10 segs from T==================================================##
            thisBatchAlldata = channsOfSegmentsForSubepPerPathway[0][index_to_data_for_batch_min_seg : index_to_data_for_batch_max_seg] + SDchannsOfSegmentsForSubepPerPathway[0][index_to_data_for_batch_min_seg : index_to_data_for_batch_max_seg] + TDchannsOfSegmentsForSubepPerPathway[0][ index_to_data_for_batch_min_adv : index_to_data_for_batch_max_adv ]

            #feed data into the normal pathway
            feeds_dict = { feeds['x'] : thisBatchAlldata }
            ##=====================================================================================##
            #feed data into the subsampled pathway
            for subsPath_i in range(cnn3d.numSubsPaths) :
                subsAlldata = channsOfSegmentsForSubepPerPathway[ subsPath_i+1 ][ index_to_data_for_batch_min_seg : index_to_data_for_batch_max_seg ] + SDchannsOfSegmentsForSubepPerPathway[subsPath_i+1][index_to_data_for_batch_min_seg : index_to_data_for_batch_max_seg] + TDchannsOfSegmentsForSubepPerPathway[ subsPath_i+1 ][ index_to_data_for_batch_min_adv:index_to_data_for_batch_max_adv ]
                feeds_dict.update( { feeds['x_sub_'+str(subsPath_i)]: subsAlldata } )
            ...
            ##==========================================Waiting to be considered, add yDD gt!!!!!!======##
            feeds_dict.update( { feeds['yDD_gt']: [1]*10+[0]*10 })
            feeds_dict.update( { feeds['alpha']: float(thisalpha)} )
...
##======================================Get Alpha of This Epoch======================##
def getAlphaOfThisEpoch(epoch):
    alpha_max = 0.05
    e2 = 35.0
    e1 = 10.0
    ...
    alpha = alpha_max * ((epoch - e1) / (e2 - e1))
...
def do_training(sessionTf,
    ...
    SDtupleWithParametersForTraining = (log,
                                    "train",
                                    run_input_checks,
                                    cnn3dWrapper,
                                    maxNumSubjectsLoadedPerSubepoch,
                                    ...
                                    listOfFilepathsToEachChannelOfEachPatientTraining[:Snum],
                                    
                                    listOfFilepathsToGtLabelsOfEachPatientTraining[:Snum],
                                    
                                    providedRoiMaskForTrainingBool,
                                    listOfFilepathsToRoiMaskOfEachPatientTraining[:Snum],
                                    ...
                                    listOfFilepathsToEachSubsampledChannelOfEachPatientTraining[:Snum],
    ...
    ##======================================================================================================##
    TDtupleWithParametersForValidation = (log,
                                    "val",
                                    run_input_checks,
                                    cnn3dWrapper,
                                    maxNumSubjectsLoadedPerSubepoch,
    ...
    SDtupleWithParametersForValidation = (log,
                                    "val",
                                    run_input_checks,
                                    cnn3dWrapper,
                                    maxNumSubjectsLoadedPerSubepoch,
                                    ...
                                    listOfFilepathsToEachChannelOfEachPatientValidation[:Snum],
                                    
                                    listOfFilepathsToGtLabelsOfEachPatientValidationOnSamplesAndDsc[:Snum],
                                    
                                    providedRoiMaskForValidationBool,
                                    listOfFilepathsToRoiMaskOfEachPatientValidation[:Snum],
                                    ...
                                    listOfFilepathsToEachSubsampledChannelOfEachPatientValidation[:Snum],
...
##===============================================================================================================##
    ...
    while model_num_epochs_trained < n_epochs :
        ...
        ##============================Get the value of alpha in training steps==============##
        thisalpha = getAlphaOfThisEpoch(epoch)
        ##==================================================================================##
        ...
        for subepoch in range(number_of_subepochs): #per subepoch I randomly load some images in the gpu. Random order.
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                if boolItIsTheVeryFirstSubepochOfThisProcess :
                    ...
                    ##===================================================================================##
                    [SDchannsOfSegmentsForSubepPerPathwayVal,
                    placeholderNothing] = getSampledDataAndLabelsForSubepoch(log,
                                                                        "val",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
                    ...
                    [TDchannsOfSegmentsForSubepPerPathwayVal,
                    placeholderNothing] = getTDSampledDataAndLabelsForSubepoch(log,
                                                                        "val",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
                ...
                ##=====================================================================================##
                    [TDchannsOfSegmentsForSubepPerPathwayVal,
                    placeholderNothing] = TDparallelJobToGetDataForNextValidation() #fromParallelProcessing that had started from last loop when it was submitted.
                
                    [SDchannsOfSegmentsForSubepPerPathwayVal,
                    placeholderNothing] = SDparallelJobToGetDataForNextValidation()
                ##==========================================================================================##
                ...
                SDparallelJobToGetDataForNextTraining = job_server.submit(getSampledDataAndLabelsForSubepoch, #local function to call and execute in parallel.
                                                                        SDtupleWithParametersForTraining, #tuple with the arguments required
                                                                        tupleWithLocalFunctionsThatWillBeCalledByTheMainJob, 
                                                                        tupleWithModulesToImportWhichAreUsedByTheJobFunctions) 
                ##=========================================================================================================================##
            ...
            if (not performValidationOnSamplesDuringTrainingProcessBool) and boolItIsTheVeryFirstSubepochOfThisProcess :                    
                ...
                [SDchannsOfSegmentsForSubepPerPathwayTrain,
                placeholderNothing] = getSampledDataAndLabelsForSubepoch(log,
                                                                        "train",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
            ...
            ##===================================================================================================================================##
                ...
                ##==================================================================##
                [TDchannsOfSegmentsForSubepPerPathwayTrain,
                placeholderNothing] = TDparallelJobToGetDataForNextTraining()

                [SDchannsOfSegmentsForSubepPerPathwayTrain,
                placeholderNothing] = SDparallelJobToGetDataForNextTraining()
                ##================================================================================##
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                ...
                ##====================================================================================================================###
                TDparallelJobToGetDataForNextValidation = job_server.submit(getTDSampledDataAndLabelsForSubepoch, 
                                                                            TDtupleWithParametersForValidation, 
                                                                            tupleWithLocalFunctionsThatWillBeCalledByTheMainJob, 
                                                                            tupleWithModulesToImportWhichAreUsedByTheJobFunctions)

                SDparallelJobToGetDataForNextValidation = job_server.submit(getSampledDataAndLabelsForSubepoch, 
                                                                            SDtupleWithParametersForValidation, 
                                                                            tupleWithLocalFunctionsThatWillBeCalledByTheMainJob, 
                                                                            tupleWithModulesToImportWhichAreUsedByTheJobFunctions)
                ##=============================================================================================================================##
