...
'''
Classic Fine-tune, no augmentation, pre-trained on tumor, fine-tune on stroke data.
'''
...
from deepmedicMT.neuralnet.cnn3d import Cnn3d
    ...
    def run_session(self, *args):
        ...
        with tf.Session( graph=graphTf, config=tf.ConfigProto(log_device_placement=False, device_count={'CPU':999, 'GPU':99}) ) as sessionTf:
            ...
            if file_to_load_params_from is not None: # Load params
                self._log.print3("=========== Loading parameters from specified saved model in Classic Ft===============")
                ...
                rdmInit_vars = collection_vars_net[-numOfExponentials-2:] ## softmax layer parameters.and also random initialize the plus units weights.
                ...
                saver_net = tf.train.Saver( var_list = collection_vars_net[:-numOfExponentials-2] ) # Used to load the net's parameters.
                ##======================================================================================================##
                ...
                try:
                    ...
                    self._log.print3("Finished assign teacher model parameters.In Mean Teacher Fine-tune. ")
                    ##===========================================================================================##
