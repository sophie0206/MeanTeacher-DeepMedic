...
from deepmedicO.neuralnet.pathwaysRP3 import NormalPathway, SubsampledPathway, FcPathway
from deepmedicO.neuralnet.layers import SoftmaxLayer
...
class Cnn3d(object):
    ...
    def make_cnn_model( self,
        ...
        thisPathway.makeFinalFlattenLayer(log,
                                                                         inputToPathwayTrain,
                                                                         inputToPathwayVal,
                                                                         inputToPathwayTest,
                                                                         inputToPathwayShapeTrain,
        ...
        self.finalTargetLayer.makeDDLayer(rng, self.getFcPathway().getLayer(-1), softmaxTemperature)
        (self._output_gt_tensor_feeds['train']['y_gt'],
         self._output_gt_tensor_feeds['val']['y_gt']) = self.finalTargetLayer.get_DDoutput_gt_tensor_feed()
