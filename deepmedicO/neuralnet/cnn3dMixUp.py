...
class Cnn3d(object):
    ...
    def setup_ops_n_feeds_to_train(self, log, total_cost, updates_of_params_wrt_total_cost) :
        ...
        self._ops_main['train']['list_rp_rn_tp_tn'] = self.finalTargetLayer.getRpRnTpTnForTrain0OrVal1_mixup(y_gt, 0, self.batchSize["train"], self._lam)
        ...
        self._lam = tf.constant(0.5)
        self._feeds_main['train']['lam'] = self._lam
