...
from deepmedicO.neuralnet.layers import ConvLayer, LowRankConvLayer, FcLayer
...
class FcPathway(Pathway):
    ...
    def getStringType(self) :
        return "FC"
    def makeFinalFlattenLayer(self,
                                                    log,
        ...
        for layer_i in range(0, numOfLayers) : 
            ...
            print(numOfLayers)
            if layer_i == 2:
                inputToNextLayerShapeTrain[0] = inputToNextLayerShapeTrain[0]//2
                inputToNextLayerShapeVal[0] = inputToNextLayerShapeVal[0]//2
                inputToNextLayerShapeTest[0] = inputToNextLayerShapeTest[0]//2
                
                inputToNextLayerShapeTrain[1] = inputToNextLayerShapeTrain[1] * 2
                inputToNextLayerShapeVal[1] = inputToNextLayerShapeVal[1] * 2
                inputToNextLayerShapeTest[1] = inputToNextLayerShapeTest[1] * 2
                
                inputToNextLayerTrain = tf.concat([inputToNextLayerTrain[:inputToNextLayerShapeTrain[0], :, :, :, :], inputToNextLayerTrain[inputToNextLayerShapeTrain[0]:, :, :, :, :]], axis=1)
                inputToNextLayerVal = tf.concat([inputToNextLayerVal[:inputToNextLayerShapeVal[0], :, :, :, :], inputToNextLayerVal[inputToNextLayerShapeVal[0]:, :, :, :, :]], axis=1)
                inputToNextLayerTest = tf.concat([inputToNextLayerTest[:inputToNextLayerShapeTest[0], :, :, :, :], inputToNextLayerTest[inputToNextLayerShapeTest[0]:, :, :, :, :]], axis=1)
            ##========================================================================================================##
