...
from deepmedicO.neuralnet.cnn3dCR import Cnn3d
from deepmedicO.neuralnet.trainerCR import Trainer

from deepmedicO.routines.trainingCR import do_training
