...
from deepmedicO.dataManagement.sampling import getSampledDataAndLabelsForSubepochCR
...
def doTrainOrValidationOnBatchesAndReturnMeanAccuraciesOfSubepoch(log,
    ...
    for batch_i in range(number_of_batches):
        ...
        if train_or_val=="train" :
            ...
            list_of_ops = [ ops_to_fetch['cost'] ] + [ ops_to_fetch['updates_grouped_op'] ]
        ...
        for subepoch in range(number_of_subepochs): #per subepoch I randomly load some images in the gpu. Random order.
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                if boolItIsTheVeryFirstSubepochOfThisProcess :
                    ...
                    labelsForCentralOfSegmentsForSubepVal] = getSampledDataAndLabelsForSubepochCR(log,
                                                                        "val",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
                ...
                parallelJobToGetDataForNextTraining = job_server.submit(getSampledDataAndLabelsForSubepochCR, #local function to call and execute in parallel.
            ...
            if (not performValidationOnSamplesDuringTrainingProcessBool) and boolItIsTheVeryFirstSubepochOfThisProcess :                    
                ...
                labelsForCentralOfSegmentsForSubepTrain] = getSampledDataAndLabelsForSubepochCR(log,
                                                                        "train",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                ...
                parallelJobToGetDataForNextValidation = job_server.submit(getSampledDataAndLabelsForSubepochCR, #local function to call and execute in parallel.
