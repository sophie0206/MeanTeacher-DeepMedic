...
from deepmedicO.dataManagement.sampling import getSampledDataAndLabelsForSubepochRo
        ...
        for subepoch in range(number_of_subepochs): #per subepoch I randomly load some images in the gpu. Random order.
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                if boolItIsTheVeryFirstSubepochOfThisProcess :
                    ...
                    labelsForCentralOfSegmentsForSubepVal] = getSampledDataAndLabelsForSubepochRo(log,
                                                                        "val",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
                ...
                parallelJobToGetDataForNextTraining = job_server.submit(getSampledDataAndLabelsForSubepochRo, #local function to call and execute in parallel.
            ...
            if (not performValidationOnSamplesDuringTrainingProcessBool) and boolItIsTheVeryFirstSubepochOfThisProcess :                    
                ...
                labelsForCentralOfSegmentsForSubepTrain] = getSampledDataAndLabelsForSubepochRo(log,
                                                                        "train",
                                                                        run_input_checks,
                                                                        cnn3dWrapper,
                                                                        maxNumSubjectsLoadedPerSubepoch,
            ...
            if performValidationOnSamplesDuringTrainingProcessBool :
                ...
                parallelJobToGetDataForNextValidation = job_server.submit(getSampledDataAndLabelsForSubepochRo, #local function to call and execute in parallel.
